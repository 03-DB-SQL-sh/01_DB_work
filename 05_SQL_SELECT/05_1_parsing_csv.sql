...
(
    ...
    price DECIMAL(6,2) NOT NULL,	    -- Preis pro Aktie in $ per 12/2019_mit 2 nachkommastellen
...
LOAD DATA LOCAL INFILE "C:\\Users\\CC-Student\\Desktop\\WB_DB\\01_DB_work\\05_SQL_SELECT\\ccc_dez_2019.csv" /*mein pfad mit Doppelbackslashes von csv datei in explorer*/
INTO TABLE stocks.ccc
FIELDS TERMINATED BY ";" 
LINES TERMINATED BY "\n" /*Datensetze trennen mit zeilenumbruch*/
IGNORE 1 ROWS /*Ignore überschrift */
;
